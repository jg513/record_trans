...
f_assign_fields_3() ->
    List = [101, 102, 103, 104],
    record_assign(rec1, [{f1, integer_to_list}, undefined, any, f3], List).

f_assign_fields_4() ->
    Rec1 = #rec1{f1 = 4},
    List = [101, 102, 103, 104],
    record_assign(rec1, Rec1, [{f1, integer_to_list}, undefined, any, f3], List).

f_assign_fields_list_3() ->
    record_assign(rec1, [{f1, integer_to_list}, undefined, any, f3], [101, 102, 103, 104]).

f_assign_fields_list_4() ->
    Rec1 = #rec1{f1 = 4},
    record_assign(rec1, Rec1, [{f1, integer_to_list}, undefined, any, f3], [101, 102, 103, 104]).
...
f_copy_test_() ->
    [
        ...
        ?_assertEqual(#rec1{f1 = "101", f2 = 2, f3 = 102}, f_copy_5())
    ].
...
f_assign_test_() ->
    [
        ...
        ?_assertEqual(#rec1{f1 = "101", f2 = 2, f3 = 102}, f_assign_5())
    ].
...
f_assign_list_test_() ->
    [
        ...
        ?_assertEqual(#rec1{f1 = "101", f2 = 2, f3 = 102}, f_assign_list_5())
    ].
...
f_assign_fields_test_() ->
    [
        ?_assertEqual(#rec1{f1 = "101", f2 = 2, f3 = 104}, f_assign_fields_4()),
        ?_assertEqual(#rec1{f1 = "101", f2 = 2, f3 = 104}, f_assign_fields_5())
    ].
...
f_assign_fields_list_test_() ->
    [
        ?_assertEqual(#rec1{f1 = "101", f2 = 2, f3 = 104}, f_assign_fields_list_4()),
        ?_assertEqual(#rec1{f1 = "101", f2 = 2, f3 = 104}, f_assign_fields_list_5())
    ].
